...
@RestController
@RequestMapping("/api/fx-test-emv-kafka")
public class FxTestEmvKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FxTestEmvKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public FxTestEmvKafkaResource(KafkaProperties kafkaProperties) {
